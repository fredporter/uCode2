# Legacy Spatial/Multimedia Prototype

> **Superseded identity (2026-08-20):** There are only two uCode generations.
> This tree is an unaudited research prototype for uCode 2; it is not an
> active uCode4 product or a production runtime. uCode 2 will restart from a
> clean scaffold; this tree is quarantined as reference. See
> [`../RESET_AND_RESCAFFOLD_PLAN.md`](../RESET_AND_RESCAFFOLD_PLAN.md). Media
> server/player and household concepts belong to the separate HomeNest
> project. Preserve this code for evaluation, but do not build new uCode 2 work
> on it until the module inventory and clean rescaffold are complete.
